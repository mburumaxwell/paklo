...
Subject to these Terms of Service (this "Agreement"), [paklo.app](/)
("Paklo", "we", "us" and/or "our") provides access to Paklo's cloud
...
By signing up and using the services provided by Paklo (referred to as the
"Service"), you are agreeing to be bound by the following terms and conditions
("Terms of Service"). The Service is owned and operated by Paklo ("Us",
"We", or "Our").

## 2. Description of Service

Paklo is a hosted software service that helps teams manage and update
software dependencies by analysing repositories and configuration, and by
generating update proposals (for example pull requests) and related reporting.
Paklo may integrate with third-party platforms (such as source code hosting
and CI services) and will only access repositories and data you connect and
authorise. The Product is accessible at paklo.app and other domains and
...
of such material and are protected by United Kingdom and international copyright,
...
directed to our support team at <support@paklo.app>.
...
accordance with the internal laws of United Kingdom without giving effect to
any choice or conflict of law provision or rule. Any legal suit, action, or
proceeding arising out of, or related to, these Terms of Service or the
Website shall be instituted exclusively in the federal courts of United Kingdom.

---

By using Paklo, you acknowledge that you have read these Terms of Service,
